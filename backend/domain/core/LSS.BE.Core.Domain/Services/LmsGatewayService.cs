...
{
    public class LmsGatewayService : ILmsGatewayService
    {
        ...
        public JObject LspVerification(LspUserAccess model)
        {
            ...
            var response = _httpHandler.PostRequestResolver(request, HttpMethod.Post, _uriString, _version, _clientId, _clientSecret, UriAbsolutePath.CheckAccess, _tokenResponse.AccessToken, _dateTime);
        ...
        public JObject VerifyOtp(VerifyOtp model)
        {
            ...
            var response = _httpHandler.PostRequestResolver(request, HttpMethod.Post, _uriString, _version, _clientId, _clientSecret, UriAbsolutePath.VerifyOtp, _tokenResponse.AccessToken, _dateTime);
        ...
        public JObject LockerStationDetails(string lockerStationId)
        {
            ...
            var response = _httpHandler.GetRequestResolver(_uriString, queryString, _version, _clientId, _clientSecret, UriAbsolutePath.LockerStationDetails, _tokenResponse.AccessToken, _dateTime);
        ...
        public JObject FindBooking(string trackingNumber, string lockerStationId, string lspId)
        {
            ...
            var response = _httpHandler.GetRequestResolver(_uriString, queryString, _version, _clientId, _clientSecret, UriAbsolutePath.FindBooking, _tokenResponse.AccessToken, _dateTime);
        ...
        public JObject AssignSimilarSizeLocker(AssignSimilarSizeLocker model)
        {
            ...
            var response = _httpHandler.PostRequestResolver(request, HttpMethod.Post, _uriString, _version, _clientId, _clientSecret, UriAbsolutePath.AssignSimilarSizeLocker, _tokenResponse.AccessToken, _dateTime);
        ...
        public JObject GetAvailableSizes(string lockerStationId)
        {
            ...
            var response = _httpHandler.GetRequestResolver(_uriString, queryString, _version, _clientId, _clientSecret, UriAbsolutePath.AvailableSizes, _tokenResponse.AccessToken, _dateTime);
            Log.Information("[Get Available Sizes][Res]" + "[" + response + "]");
        ...
        public JObject ChangeLockerSize(ChangeLockerSize model)
        {
            ...
            var response = _httpHandler.PostRequestResolver(request, HttpMethod.Post, _uriString, _version, _clientId, _clientSecret, UriAbsolutePath.ChangeLockerSize, _tokenResponse.AccessToken, _dateTime);
        ...
        public JObject UpdateBookingStatus(BookingStatus model)
        {
            ...
            var response = _httpHandler.PostRequestResolver(request, HttpMethod.Put, _uriString, _version, _clientId, _clientSecret, UriAbsolutePath.UpdateBookingStatus, _tokenResponse.AccessToken, _dateTime);
        ...
        public JObject ChangeSingleLockerStatus(ChangeLockerStatus model)
        {
            ...
            var response = _httpHandler.PostRequestResolver(request, HttpMethod.Put, _uriString, _version, _clientId, _clientSecret, UriAbsolutePath.ChangeSingleLockerStatus, _tokenResponse.AccessToken, _dateTime);
        ...
        public JObject RetrieveLockersBelongsToCourier(string lockerStationId, string lspId, string trackingNumber, string status) 
        {
            ...
            var response = _httpHandler.GetRequestResolver(_uriString, queryString, _version, _clientId, _clientSecret, UriAbsolutePath.RetrieveLockersBelongsCourier, _tokenResponse.AccessToken, _dateTime);
